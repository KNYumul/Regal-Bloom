        ...
        <div class=" row">
            <div class="col px-0">
                <div class="banner-crop">
                    <img src="Resources/banner2.png" alt="banner" class="banner-img" id="candidateBanner-position">
                    <img src="Resources/userCandidatesBanner.png" alt="banner" class="banner-text"  width="80%">
                </div>
            </div>
        </div>
    </div>
